...
func (m *MockGraph) InsertEdge(arg0 *graph.Edge) error {
	m.ctrl.T.Helper()
...
func (mr *MockGraphMockRecorder) InsertEdge(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InsertEdge", reflect.TypeOf((*MockGraph)(nil).InsertEdge), arg0)
}

// InsertLink mocks base method
func (m *MockGraph) InsertLink(arg0 *graph.Link) error {
	m.ctrl.T.Helper()
...
func (mr *MockGraphMockRecorder) InsertLink(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InsertLink", reflect.TypeOf((*MockGraph)(nil).InsertLink), arg0)
}
